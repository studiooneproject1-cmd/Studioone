...
import { editService } from "@/app/models/db/lib/actions/services";
          ...
          <CardContent className="flex flex-col items-start gap-5 mb-7">
            ...
            <div className="flex flex-col">
              <label className="text-base text-black mb-1">
                <span className="text-red-500 text-sm">*</span> Name (name Text EN)
              </label>
              <input
                type="text"
                name="name"
            ...
            <div className="flex flex-col">
              <label className="text-base text-black mb-1">
                <span className="text-red-500 text-sm">*</span> Name (name Text AR)
              </label>
              <input
                type="text"
                name="name_ar"
    ...
    {/*SHORT DESCRIPTION EN */}
            ...
            <div className="w-full flex justify-center mt-5">
              <div className="flex flex-row gap-3">
                ...
                <button
                  type="submit"
                  className="bg-blue-600text-white px-4 py-2 rounded-md cursor-pointer hover:bg-blue-500"
                  disabled={isPending}
                >
